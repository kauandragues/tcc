                              ...
                              if(mysqli_num_rows($buscar)==0)
                                 ...
                                 while($encontrou=mysqli_fetch_array($buscar)){
                                    ...
                                    echo "<div class='col-md-4'>
                                             <div class='box_main'>";
                                             $buscarFav = mysqli_query($conectar,"select * from FAVORITO WHERE FK_USUARIO = '$email' && FK_OBRA= '$idobra';");
                                             if(mysqli_num_rows($buscarFav) > 0){
                                                echo "<img src='css/Amei.png' style='max-width: 30%'>
                                                <p class='chair_text'>".$nome."</p>
                                                <div class='image_3' href='obra.php'><img src='".$imagem."'></div>
                                                <form method='POST' action='desfavoritar.php'>
                                                            <select id='idobra' name='idobra'>
                                                               <option value='$idobra' selected>
                                                            </select>
                                                            <input id='Amei$contador' type='submit' name='$idobra' value='DESFAVORITAR' class='fav'>
                                                         </form>
                                                ...
                                                echo "
                                                      ...
                                                      <form method='POST' action='favoritar.php'>
                                                         ...
                                                         <input id='Amei$contador' type='submit' name='$idobra' value='FAVORITAR' class='fav'>
                                                      </form>
                                                      <p class='chair_text'>".$tipo."</p>
                                                      <p class='chair_text'>".$data."</p>
                                                      <p class='chair_text'>".$autor."</p>
